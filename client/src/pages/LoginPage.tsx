...
import { TicketCheck, Eye, EyeOff, Loader } from 'lucide-react';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <div style={{ textAlign: 'center', margin: '16px 0' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginBottom: 12 }}>— or —</p>
          <a
        ...
        <p className={styles.hint}>
          Demo: <strong>admin@helpdesk.com</strong> / <strong>admin123</strong>
        </p>
